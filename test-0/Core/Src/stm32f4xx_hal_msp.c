...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB9     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(BRL64WE2_SCL_GPIO_Port, BRL64WE2_SCL_Pin);

    HAL_GPIO_DeInit(BRL64WE2_SDA_GPIO_Port, BRL64WE2_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(TMC_CLK_GPIO_Port, TMC_CLK_Pin);
