...
/* Private defines -----------------------------------------------------------*/
#define TMC4671_CS_Pin GPIO_PIN_3
#define TMC4671_CS_GPIO_Port GPIOA
#define TMC6100_CS_Pin GPIO_PIN_4
#define TMC6100_CS_GPIO_Port GPIOA
#define TMC_CLK_Pin GPIO_PIN_5
#define TMC_CLK_GPIO_Port GPIOA
...
#define BRL64WE2_SCL_Pin GPIO_PIN_10
#define BRL64WE2_SCL_GPIO_Port GPIOB
...
#define BRL64WE2_SDA_Pin GPIO_PIN_9
#define BRL64WE2_SDA_GPIO_Port GPIOB
